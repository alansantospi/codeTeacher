...
public class AutoSuggestor extends JComponent {
...
//		suggestionsPanel.set
	...
	private void addKeyBindingToRequestFocusInPopUpWindow() {
		...
		textField.getInputMap(JComponent.WHEN_FOCUSED).put(KeyStroke.getKeyStroke(KeyEvent.VK_UP, 0, true),
				"Up released");
	...
	private void showPopUpWindow() {
		...
		windowX = (int) locationOnScreen.getX();
		windowY = (int) locationOnScreen.getY() + textField.getHeight();
...
//                }
//            }
			if (!word.toLowerCase().contains(typedWord.toLowerCase())) {// check for match
				fullymatches = false;
			}
			if (fullymatches) {
