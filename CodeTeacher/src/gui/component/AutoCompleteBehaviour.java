 ...
 * 
 * <p>
 * Pressing CTRL-SPACE will show the auto-complete
 * 
 * popup. While the popup is shown, all key events
 * 
 * related to the following keys are consumed
 * 
 * and used to control the proposal selection:
 * </p>
 * 
 * 
 * 
 ...
 * 
 * <li>SPACE / ENTER - inserts the currently selected auto-complete proposal
 * into the text component</li>
 * 
...
public class AutoCompleteBehaviour<T> {
	...
	public interface IAutoCompleteCallback<X> {
		 ...
		 * 
		 * @param caretPosition caret position where the auto-complete proposal has been
		 *                      triggered
		 * 
		 * @return user input to use for fetching the initial set of proposals or
	...
	private final class AutoCompleteBuffer {
		...
		public boolean isValidOffset(int offset) {
			return offset >= autoCompleteCaretStartPosition
					&& offset <= (autoCompleteCaretStartPosition + buffer.length());
		}
...
//			if (e.getKeyCode() == KeyEvent.VK_SPACE && isCtrlDown(e)) {
	...
	protected void showPopup(Rectangle rect, long activationTimestamp, String initialContent,
			int autoCompleteStartCaretPosition) {
		if (!autoCompleteActive) {
	 ...
	 * 
	 * <p>
	 * Make sure you set a custom {@link IAutoCompleteCallback callback} , otherwise
	 * 
	 * it will look like auto-completion is not working.
	 * </p>
	 * 
	 * <p>
	 * This behaviour may only be attached to at most text component at any
	 * 
	 * time. Use {@link #detach()} to detach it from its current editor component.
	 * </p>
	 * 
	 * 
	 * 
...
//		}
	 ...
	 * 
	 * <p>
	 * If this behaviour is currently not attached, nothing (bad) happens.
	 * </p>
	 * 
	 * 
	 * 
