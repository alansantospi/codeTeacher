...
public class FrameAddParam extends JFrame {
	...
	private FrameAddParam thisFrame;
	private FrameAddOutput previousFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameAddParam frame = new FrameAddParam(null);
	 ...
	 * Create the frame.
	 */
	public FrameAddParam(FrameAddOutput previousFrame) {
		this.thisFrame = this;
