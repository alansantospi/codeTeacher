...
import gui.component.CheckBoxNodeEditor;
import gui.component.CheckBoxNodeRenderer;
import gui.component.checkboxTree.jcheckboxtree.JCheckBoxTree;

public class DynamicTreeExample extends JPanel implements ActionListener {
	...
	public DynamicTreeExample() {
		...
		treePanel = new DynamicTree(new DefaultMutableTreeNode(TESTS));
	...
	private static void createAndShowGUI() {
		...
		DynamicTreeExample newContentPane = new DynamicTreeExample();
...
class DynamicTree extends JPanel {
	...
	public DynamicTree(DefaultMutableTreeNode root, boolean check) {
		this(root);
		if (check) {
	...
	public void addChildren(DefaultMutableTreeNode parent, File parentFile) {
//		File parentFile = (File) parent.getUserObject();
		File[] children = parentFile.listFiles();
		if (children != null) {
			for (int i = 0; i < children.length; i++) {
				String fileName = ((File) children[i]).getName();
				DefaultMutableTreeNode child = new DefaultMutableTreeNode(
				 new CheckBoxNode(fileName, false));
