...
public class DriveManager {
   ...
   */
  private static final String APPLICATION_NAME = "Code Teacher Web";
...
//      new java.io.File(System.getProperty("user.home"), ".store/drive_sample"); 
  ...
  private static Credential authorize() throws Exception {
    ...
    GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
        new InputStreamReader(DriveManager.class.getResourceAsStream("/client_secrets.json")));
  ...
  public static void main(String[] args) {
    Preconditions.checkArgument(
        ...
        "Please enter the upload file path and download directory in %s", DriveManager.class);
