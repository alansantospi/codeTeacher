...
/**
 * Custom implementation of ParseASM, sice it do not create class members with package-private visibilibity, also known as default modifier
 * @see {@link ParseASM} 
 */
public class CustomParseASM extends ParseASM {
     ...
     *            to build
     */
    public CustomParseASM(final IClassReader reader) {
    	super(reader);
        this.reader = reader;
    }
    ...
    private void addEnumFieldValues() {
        ...
        final FieldImp field = new FieldImp(CustomParseASM.ENUM_VALUES, Enum.class);
    ...
    private void createValuesEnum() {
        ...
        mv.visitFieldInsn(Opcodes.GETSTATIC, this.getEntityName(), CustomParseASM.ENUM_VALUES, this.getEntityEnumNameArray());
        mv.visitInsn(Opcodes.DUP);
    ...
    private boolean isDefaultFieldEnumValues(final IFieldReader field) {
        ...
        return CustomParseASM.ENUM_VALUES.equals(field.name());
    }
}